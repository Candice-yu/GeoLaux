...
client = OpenAI(
    ...
    api_key='sk-r3TS11KGnsSqp2MuXQw9zIAKO81voY5Stniib16w35yQZ8Z8',# yunwu  Candice_yu
    # api_key='sk-00hxDhnnx4VxWnHdBEB9KrOlDaccavszCwkAgUDLPeXG0Kbt',# yunwu  answer_generator
    timeout=300
)
...
if __name__ == "__main__":
    json_file_path = '../data/mini_data.json'
